...
Original file is located at
    https://colab.research.google.com/drive/1l9FJ2AZ1SpNgLiueUSL51uO1lKeo3xe3
"""
...
def T(s,a,snext, Tdict):
    if (s,a,snext) in Tdict:
        return (snext,Tdict[s,a,snext])
    return (0,0)
    ...
    for i in range(1,5):
        for j in range(1,12):
            if (7, i,j) in Tdict:
                ...
                print(T(7, i, j, mdpFunc()))
                print("direction: ", i)
    
#first(mdpFunc())
#print("=====")
#print(T(7, 4, 11, mdpFunc()))
